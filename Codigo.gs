/************************************************
 * SISTEMA DE DEVOLUCIÓN DE TRÁMITES
 * Codigo.gs
 ************************************************/
...
function doGet() {
  return HtmlService
    ...
    .setTitle("DEVOLUCIÓN DE TRÁMITES");
}
...
function verificarEstructura() {
  return {
    devoluciones: obtenerHoja(HOJA_DEVOLUCIONES).getLastRow(),
    detalle: obtenerHoja(HOJA_DETALLE).getLastRow(),
    funcionarios: obtenerHoja(HOJA_FUNCIONARIOS).getLastRow()
  };
}
